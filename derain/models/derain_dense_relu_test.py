...
class conf0(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(72,32,3,1,1)
    ...
    def forward(self, x):
        ...
        residual = self.relu(self.refine3(x_6))
...
class tower(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(171,32,3,1,1)
        self.conv2 = BottleneckBlock(32, 32)
        self.trans_block2 = TransitionBlock(64, 32)
    ...
    def forward(self, x):
        ...
        residual = self.relu(self.refine3(x1))
...
class Dense_rainall(nn.Module):
    def __init__(self):
        ...
        self.convq1 = nn.Conv2d(3, 24, 1, 1, 0)
        self.convx1 = nn.Conv2d(144, 18, 1, 1, 0)
...
class Dense_base_down2(nn.Module):
    def __init__(self):
        ...
        self.dense_block1=BottleneckBlock2(24,24)
        self.trans_block1=TransitionBlock(48,24)
        ############# Block2-down 32-32  ##############
        self.dense_block2=BottleneckBlock2(24,24)
        self.trans_block2=TransitionBlock(48,24)

        ############# Block3-down  16-16 ##############
        self.dense_block3=BottleneckBlock2(24,24)
        self.trans_block3=TransitionBlock(48,24)
...
class Dense_base_down22(nn.Module):
    def __init__(self):
        ...
        ############# Block4-up  8-8  ##############
        self.dense_block4=BottleneckBlock2(24,24)
        self.trans_block4=TransitionBlock(48,24)

        ############# Block5-up  16-16 ##############
        self.dense_block5=BottleneckBlock2(57,24)
        self.trans_block5=TransitionBlock(81,24)

        self.dense_block6=BottleneckBlock2(57,24)
        self.trans_block6=TransitionBlock(81,24)
...
class Dense_base_down1(nn.Module):
    def __init__(self):
        ...
        self.dense_block1=BottleneckBlock1(24,24)
        self.trans_block1=TransitionBlock(48,24)
        ############# Block2-down 32-32  ##############
        self.dense_block2=BottleneckBlock1(24,24)
        self.trans_block2=TransitionBlock(48,24)

        ############# Block3-down  16-16 ##############
        self.dense_block3=BottleneckBlock1(24,24)
        self.trans_block3=TransitionBlock(48,24)
...
class Dense_base_down11(nn.Module):
    def __init__(self):
        ...
        ############# Block4-up  8-8  ##############
        self.dense_block4=BottleneckBlock1(24,24)
        self.trans_block4=TransitionBlock(48,24)

        ############# Block5-up  16-16 ##############
        self.dense_block5=BottleneckBlock1(57,24)
        self.trans_block5=TransitionBlock(81,24)

        self.dense_block6=BottleneckBlock1(57,24)
        self.trans_block6=TransitionBlock(81,24)
...
class Dense_base_down0(nn.Module):
    def __init__(self):
        ...
        self.dense_block1=BottleneckBlock(24,24)
        self.trans_block1=TransitionBlock(48,24)
        ############# Block2-down 32-32  ##############
        self.dense_block2=BottleneckBlock(24,24)
        self.trans_block2=TransitionBlock(48,24)

        ############# Block3-down  16-16 ##############
        self.dense_block3=BottleneckBlock(24,24)
        self.trans_block3=TransitionBlock(48,24)
...
class Dense_base_down00(nn.Module):
    def __init__(self):
        ...
        ############# Block4-up  8-8  ##############
        self.dense_block4=BottleneckBlock(24,24)
        self.trans_block4=TransitionBlock(48,24)

        ############# Block5-up  16-16 ##############
        self.dense_block5=BottleneckBlock(57,24)
        self.trans_block5=TransitionBlock(81,24)

        self.dense_block6=BottleneckBlock(57,24)
        self.trans_block6=TransitionBlock(81,24)
